...
This document is the "why". For how it is built, see [Architecture](Architecture); for what it
proves, see [Value Proof](Value-Proof).
...
grounding, not the model. (Full numbers in [Value Proof](Value-Proof).)
