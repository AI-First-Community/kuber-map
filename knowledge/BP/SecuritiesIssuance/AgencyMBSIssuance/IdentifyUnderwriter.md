...
relations:
  ...
  - {type: results-in-appointment-of, target: "/BP/SecuritiesIssuance/AgencyMBSIssuance/PotentialPassThroughIssuanceUnderwriter.md", provenance: fibo}
---

FIBO class *identify underwriter*.

### Relationships
- is-a: [IssuanceProcessActivity](/BP/SecuritiesIssuance/IssuanceProcess/IssuanceProcessActivity.md)
- results-in-appointment-of: [PotentialPassThroughIssuanceUnderwriter](/BP/SecuritiesIssuance/AgencyMBSIssuance/PotentialPassThroughIssuanceUnderwriter.md)
