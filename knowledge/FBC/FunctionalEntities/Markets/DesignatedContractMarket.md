...
description: "exchange, trading system, or platform that enables listing for trading futures or option contracts based on any underlying commodity, index or instrument"
...
relations:
  ...
  - {type: is-classified-by, target: "/FBC/FunctionalEntities/Markets/MarketCategoryClassifier-DCMS.md", provenance: fibo}
---
...
- is-classified-by: [MarketCategoryClassifier-DCMS](/FBC/FunctionalEntities/Markets/MarketCategoryClassifier-DCMS.md)
