...
relations:
  ...
  - {type: has-observed-date-time, target: "/CMNS/DatesAndTimes/CombinedDateTime.md", provenance: fibo}
---
...
- has-observed-date-time: [CombinedDateTime](/CMNS/DatesAndTimes/CombinedDateTime.md)
