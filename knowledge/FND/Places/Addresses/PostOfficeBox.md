...
### Relationships
- is-a: [SupplementalAddressComponent](/FND/Places/Addresses/SupplementalAddressComponent.md)
- comprises: [PostOfficeBoxDesignator](/FND/Places/Addresses/PostOfficeBoxDesignator.md)
