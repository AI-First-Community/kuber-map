...
description: "common share that confers multiple votes per share, is restricted from a sales / transfer perspective, is nil paid and is registered"
...
relations:
  ...
  - {type: is-classified-by, target: "/SEC/Equities/EquityCFIClassificationIndividuals/ESETOR.md", provenance: fibo}
---
...
- is-classified-by: [ESETOR](/SEC/Equities/EquityCFIClassificationIndividuals/ESETOR.md)
