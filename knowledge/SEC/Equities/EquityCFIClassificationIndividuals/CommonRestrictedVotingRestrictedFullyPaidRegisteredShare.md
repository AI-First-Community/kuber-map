...
description: "common share that confers less than one vote per share, is restricted from a sales / transfer perspective, is fully paid and is registered"
...
relations:
  ...
  - {type: is-classified-by, target: "/SEC/Equities/EquityCFIClassificationIndividuals/ESRTFR.md", provenance: fibo}
---
...
- is-classified-by: [ESRTFR](/SEC/Equities/EquityCFIClassificationIndividuals/ESRTFR.md)
