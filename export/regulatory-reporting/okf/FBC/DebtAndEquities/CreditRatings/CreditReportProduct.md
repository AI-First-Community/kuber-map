...
description: "branded credit report offered in the marketplace"
...
examples:
  - "A tri-merge credit report product combining Equifax, Experian, and TransUnion data."
examples_provenance: curated
relations:
  - {type: is-a, target: "/FBC/ProductsAndServices/FinancialProductsAndServices/FinancialProduct.md", provenance: fibo}
  - {type: is-a, target: "/FND/ProductsAndServices/ProductsAndServices/OffTheShelfProduct.md", provenance: fibo}
...
- is-a: [OffTheShelfProduct](/FND/ProductsAndServices/ProductsAndServices/OffTheShelfProduct.md)
