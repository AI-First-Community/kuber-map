# Context pack — Regulatory Reporting & Compliance (supervisory filing)
...
```
python etl/mcp_server.py --pack export/Regulatory Reporting & Compliance (supervisory filing)/pack.json
```
...
## Citation model
52 concepts, 4 curated bridges. Each concept's `citation` is its
