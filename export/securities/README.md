# Context pack — Securities Instruments & Issuance (capital markets)
...
```
python etl/mcp_server.py --pack export/Securities Instruments & Issuance (capital markets)/pack.json
```
...
## Citation model
59 concepts, 3 curated bridges. Each concept's `citation` is its
