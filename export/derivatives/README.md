# Context pack — Derivatives Contracts & Trading (options, futures, swaps)
...
```
python etl/mcp_server.py --pack export/Derivatives Contracts & Trading (options, futures, swaps)/pack.json
```
...
## Citation model
60 concepts, 4 curated bridges. Each concept's `citation` is its
