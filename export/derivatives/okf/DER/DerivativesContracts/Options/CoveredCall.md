...
type: FIBO Class
title: "covered call"
description: "call option in which the seller (investor) owns an equivalent amount of the underlying security"
...
examples:
  - "Selling a call on shares you already own to earn the premium."
